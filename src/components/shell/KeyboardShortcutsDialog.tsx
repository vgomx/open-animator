...
const SHORTCUTS = [
  ...
  { keys: '⌘C', action: 'Copy keyframes at playhead, or copy selected layers' },
  { keys: '⌘V', action: 'Paste keyframes at playhead, or paste copied layers' },
  { keys: '← / →', action: 'Nudge selected keyframes by one frame' },
  { keys: '⇧← / ⇧→', action: 'Nudge selected keyframes by 0.1s' },
  { keys: 'Delete / Backspace', action: 'Delete selected keyframes, layer, or nodes' },
